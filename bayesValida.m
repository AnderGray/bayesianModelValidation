...
%
%   This script produces the model, data and posterior assosiated with
...
title('posterior')
set(gca,'FontSize',18)
xlabel('V','FontSize',21) 
ylabel('prob','FontSize',21)  
...
errorbar(dataLocations,dataVals,dataErrors,'o');
title('test function')
set(gca,'FontSize',18)
xlabel('input space','FontSize',21)  
ylabel('output space','FontSize',21)  
